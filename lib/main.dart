                        ...
                        isEnoughPoints
                          ...
                          children: [
                            Container(
                              ...
                              child: const Text('Poin Tidak Cukup', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Color(0xFF6B6B6B))),
                            ),
                            const SizedBox(height: 8),
                            SizedBox(
                              width: double.infinity,
                ...
                ElevatedButton(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: 11,
                      fontWeight: FontWeight.w700,
                      color: isButtonEnabled ? Colors.white : const Color(0xFF6B6B6B),
                    ),
                  ),
                ),
              ],
